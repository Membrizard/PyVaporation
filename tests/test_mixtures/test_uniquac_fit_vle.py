...
def test_fit_uniquac_vle():
    ...
    assert abs(params.alpha_12 - 21.127561704493143) < 1e-3
    assert abs(params.alpha_21 - 100.10268878024358) < 1e-3
    assert abs(params.beta_12 - -0.9175664931087569) < 1e-3
    assert abs(params.beta_21 - 2.4619377106475753) < 1e-3
    assert params.z == 13
