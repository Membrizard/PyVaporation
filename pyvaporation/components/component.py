...
from ..utils import HeatCapacityConstants, R, VaporPressureConstants, VPConstantsType, UNIQUACParameters
...
class Component:
    ...
    uniquac_parameters: typing.Optional[UNIQUACParameters] = None
